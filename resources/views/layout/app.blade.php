    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/sbadmin2/index.html">
                ...
                <div class="sidebar-brand-text mx-3">Toko Andalas</div>
            </a>
            ...
            <!-- Nav Item - Menu Data Master dan Data Pesanan -->
            <li class="nav-item">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            <a class="nav-link dropdown-toggle" href="/sbadmin2/#" id="searchDropdown" role="button"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Toko Sepatu Andalas 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
